...
(function() {
    ...
    document.body.innerHTML += '<div id="back2Top" style="width: 30px; height: 30px; position: fixed; bottom: 10px; right: 10px; background-color: #7D7; display: none;"><img src="http://www.iconarchive.com/download/i86026/graphicloads/100-flat-2/arrow-up.ico" alt="Back To Top"/></div>';
